...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(dat.crime}\SpecialCharTok{$}\NormalTok{Ed, dat.crime}\SpecialCharTok{$}\NormalTok{R, }\AttributeTok{main=}\StringTok{"Relationship between reported crime rate and mean years of schooling"}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"Mean of years Schooling x10"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Reported Crime Rate"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(dat.crime}\SpecialCharTok{$}\NormalTok{Ed, dat.crime}\SpecialCharTok{$}\NormalTok{R)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{crime.lm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\AttributeTok{formula =}\NormalTok{ dat.crime}\SpecialCharTok{$}\NormalTok{R }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dat.crime}\SpecialCharTok{$}\NormalTok{Ed, }\AttributeTok{data =}\NormalTok{ dat.crime)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(dat.crime}\SpecialCharTok{$}\NormalTok{Ed, crime.lm}\SpecialCharTok{$}\NormalTok{residuals, }\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{15}\NormalTok{,}\DecValTok{15}\NormalTok{), }\AttributeTok{main=}\StringTok{"Residuals vs. x"}\NormalTok{, }\AttributeTok{xlab=}\StringTok{"x, Scaled speed"}\NormalTok{, }\AttributeTok{ylab=}\StringTok{"Residuals"}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h =} \DecValTok{0}\NormalTok{, }\AttributeTok{lty=}\StringTok{"dashed"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Journal_files/figure-latex/unnamed-chunk-67-5.pdf}
